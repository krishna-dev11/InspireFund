...
const ContactInfoCard = ({ icon: Icon, title, detail }) => (
  <div className="flex items-center justify-between p-5 border border-app rounded-[1.5rem] bg-surface hover:border-[#F97316]/50 transition-all duration-500 group cursor-pointer w-full backdrop-blur-sm">
    <div className="flex items-center gap-5">
      ...
      <div>
        <p className="text-app font-bold text-sm mb-1 uppercase tracking-[0.1em]">
          {title}
        </p>
        <p className="text-muted text-[11px] md:text-xs font-medium leading-relaxed">
          {detail}
        </p>
      </div>
    </div>
...
const GetInTouchSection = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen overflow-hidden font-sans app-bg">
      <div className="relative min-h-[600px] w-full lg:w-1/2 text-app flex flex-col justify-center px-8 md:px-16 lg:pl-24 py-20">
        <div className="absolute top-[10%] right-[-5%] select-none pointer-events-none">
          <h1 className="text-[12rem] md:text-[18rem] lg:text-[22rem] font-black tracking-tighter uppercase leading-none italic text-black/5 dark:text-white/5">
            FUND
          </h1>
        </div>
        ...
        <div className="relative z-10 flex flex-col gap-8">
          <div className="flex items-center gap-2 px-4 py-2 w-fit rounded-full border border-app bg-surface-2 shadow-inner">
          ...
          <p className="text-muted text-sm md:text-lg leading-relaxed max-w-[480px] mb-4 font-medium italic">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:pr-24 py-20 relative bg-surface-2 border-l border-app">
