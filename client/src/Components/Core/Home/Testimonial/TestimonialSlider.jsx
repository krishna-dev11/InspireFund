...
const testimonials = [
  {
    ...
    quote:
      "FundIndia helped us move from a pitch deck to real customers. The platform feels premium and trustworthy.",
  },
  {
    id: 2,
    name: "Rahul Verma",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-6">
          {testimonials.map((t) => (
            ...
            >
              <div className="group relative bg-[#0a0a0a] border border-white/[0.08] rounded-[2.5rem] p-8 h-full transition-all duration-500 hover:border-white/20 hover:shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#F97316] text-sm font-black">
                    *
                  </div>
                </div>
              </div>
